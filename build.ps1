# ============================================
# Valhalla Auth - Build Script (Windows PowerShell)
# ============================================
...
if ($LASTEXITCODE -eq 0) {
    ...
    Write-Host "Run: docker run -d --name valhalla-auth -p 8081:8081 -p 20880:20880 -e SPRING_PROFILES_ACTIVE=dev $Tag"
} else {
